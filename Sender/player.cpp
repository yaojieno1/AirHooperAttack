...
void play (const char *const song)
{
  ...
  while (pos<int(strlen(song))) {
    ...
    switch(song[pos]) {
    case 'c': printf("c\n");flushplay(); curnot=0; loaded=true; break;
    case 'd': printf("d\n");flushplay(); curnot=2; loaded=true; break;
    case 'e': printf("e\n");flushplay(); curnot=4; loaded=true; break;
    case 'f': printf("f\n");flushplay(); curnot=5; loaded=true; break;
    case 'g': printf("g\n");flushplay(); curnot=7; loaded=true; break;
    case 'a': printf("a\n");flushplay(); curnot=9; loaded=true; break;
    case 'b': printf("b\n");flushplay(); curnot=11; loaded=true; break;
    case 'p': printf("p\n");flushplay(); curnot=-1000; loaded=true; break;
    case '#': printf("#\n");curnot++; break;
    case '1': printf("1\n");flushplay(); curlen=128; break;
    case '2': printf("2\n");flushplay(); curlen=64; break;
    case '4': printf("4\n");flushplay(); curlen=32; break;
    case '5': printf("5\n");flushplay(); curlen=48; break;
    case '8': printf("8\n");flushplay(); curlen=16; break;
    case '6': printf("6\n");flushplay(); curlen=8; break;
    case 'u': printf("u\n");flushplay(); curoct=-2; break;
    case 'l': printf("l\n");flushplay(); curoct=-1; break;
    case 'h': printf("h\n");flushplay(); curoct=0; break;
    case 'x': printf("x\n");flushplay(); curoct=1; break;
    default:break;
    };
    pos++;
